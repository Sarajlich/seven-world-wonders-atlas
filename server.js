...
const wonders = [
  ...
  },
  {
    ...
    images: [
      commonsImage("Petra_Jordan_BW_21.JPG"),
      commonsImage("Treasury_petra_crop.jpeg")
    ]
  },
  {
  ...
  },
  {
    ...
    images: [
      commonsImage("Machu_Picchu,_Peru.jpg"),
      commonsImage("Before_Machu_Picchu.jpg")
    ]
  },
  {
    slug: "chichen-itza",
    ...
    images: [
      commonsImage("Chichen_Itza_3.jpg"),
      commonsImage("El_Castillo,_Chichen_Itza.jpg")
    ]
  },
  {
    slug: "colosseum",
    ...
    images: [
      commonsImage("Colosseo_2020.jpg"),
      commonsImage("Colosseum_in_Rome,_Italy_-_April_2007.jpg")
    ]
  },
  {
    slug: "taj-mahal",
    ...
    images: [
      commonsImage("Taj-Mahal.jpg"),
      commonsImage("Taj_Mahal_(Edited).jpeg")
    ]
  }
];
...
async function handleRequest(req, res) {
  ...
  if (url.pathname === "/api/wonders") {
    sendJson(res, 200, wonders);
    return;
  }

  if (url.pathname.startsWith("/api/wonders/")) {
    const slug = decodeURIComponent(url.pathname.replace("/api/wonders/", ""));
    const wonder = wonders.find((item) => item.slug === slug);
    sendJson(res, wonder ? 200 : 404, wonder || { error: "Wonder not found" });
    return;
  }
...
http.createServer((req, res) => {
  ...
  console.log(`Seven World Wonders Atlas running at http://localhost:${port}`);
});
